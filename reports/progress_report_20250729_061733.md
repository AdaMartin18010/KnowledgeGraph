...
## 生成时间 / Generated Time
2025-07-29T06:17:33.840165

## 项目状态 / Project Status

| 指标 / Metric | 数值 / Value |
|--------------|-------------|
| 总文档数 / Total Documents | 7 |
| 已完成文档 / Completed Documents | 7 |
...
| 指标 / Metric | 数值 / Value |
|--------------|-------------|
| 平均双语比例 / Average Bilingual Ratio | 20.76% |
| 包含形式化证明的文档 / Documents with Formal Proofs | 7 |
| 包含代码示例的文档 / Documents with Code Examples | 7 |
| 包含批判性分析的文档 / Documents with Critical Analysis | 7 |
| 包含参考文献的文档 / Documents with References | 7 |
